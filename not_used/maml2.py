...
class MAML:
    ...
    def construct_model(self, input_tensors=None, prefix='metatrain_'):
        ...
        with tf.variable_scope('model', reuse=None) as training_scope:
            ...
            def task_metalearn(inp, reuse=True):
                ...
                for j in range(num_updates - 1):
                    ...
                    # grads depends on the previous fast_weights
        ...
        total_losses2 = [tf.reduce_sum(lossesb[j]) / tf.to_float(25) for j in range(num_updates)]
        
        optimizer = tf.train.AdamOptimizer(self.meta_lr)
        self.gvs = gvs = optimizer.compute_gradients(total_losses2[0])
        # ================================================
        self.metatrain_op = optimizer.apply_gradients(gvs)
        # ================================================
        # Explaining compute_gradients and then apply_gradients works, see
        # https://stackoverflow.com/questions/45473682/difference-between-apply-gradients-and-minimize-of-optimizer-in-tensorflow
